...
def get_parser_results(string, strip_start_and_end = true)
...
describe Bbcode::Parser do
	...
	it "should parse 4 simple bbcode tags with text" do
		get_parser_results("[b]bold[i]and italic[/b]but not bold anymore[/i]nor italic")
	end
	...
	it "should parse a single, regular unnamed argument" do
		get_parser_results("[url=http://www.google.com/]")[0].should \
